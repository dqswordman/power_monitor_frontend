...
import { HalfHourlyChart } from "@/components/half-hourly-chart"
        ...
        {connectionStatus === "disconnected" && (
          <Alert className="border-red-200 dark:border-red-800 bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-950/50 dark:to-rose-950/50 shadow-lg">
            ...
            <AlertDescription className="text-red-800 dark:text-red-200 font-medium">
              Unable to connect to the power monitoring API. Please verify the backend server is running and accessible.
            </AlertDescription>
          </Alert>
        )}
